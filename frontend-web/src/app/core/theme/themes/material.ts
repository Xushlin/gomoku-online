...
export const materialTokens: ThemeTokens = {
  light: {
    ...
    radii: { card: '12px', control: '12px' },
    shadows: { elevated: '0 4px 12px rgb(0 0 0 / 0.12)', raised: '0 0 #0000', inset: '0 0 #0000' },
  ...
  dark: {
    ...
    radii: { card: '12px', control: '12px' },
    shadows: { elevated: '0 4px 12px rgb(0 0 0 / 0.6)', raised: '0 0 #0000', inset: '0 0 #0000' },
    surfaces: { image: 'none', edge: 'var(--color-border)', edgeWidth: '1px' },
    controls: { image: 'none', edge: 'var(--color-primary)', edgeWidth: '0px' },
    accents: { color: 'var(--color-primary)', image: 'none' },
    grounds: { image: 'none' },
