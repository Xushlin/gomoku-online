...
public class RoomJoinLeaveTests
{
    ...
    public void Second_Player_Joins_And_Starts_Game()
    {
        ...
        room.JoinAsPlayer(bobId, Now.AddMinutes(1), BuiltInGameRules.Gomoku, setup: null);
    ...
    public void Host_Rejoin_Throws()
    {
        ...
        var act = () => room.JoinAsPlayer(hostId, Now.AddMinutes(1), BuiltInGameRules.Gomoku, setup: null);
    ...
    public void Room_Full_Throws()
    {
        ...
        var act = () => room.JoinAsPlayer(UserId.NewId(), Now.AddMinutes(2), BuiltInGameRules.Gomoku, setup: null);
    ...
    public void Player_Leave_During_Play_Does_Not_Change_Game()
    {
        ...
        room.JoinAsPlayer(bob, Now.AddMinutes(1), BuiltInGameRules.Gomoku, setup: null);
